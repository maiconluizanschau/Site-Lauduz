...
if (isset($_POST['btnSend'])) {
    ...
    if ((!empty($nome)) && (!empty($email)) && (!empty($telefone)) && (!empty($crm)) && (!empty($universidade) && (!empty($cpf)&& (!empty($datanascimento)&& (!empty($especialidade)&& (!empty($cidade)&& (!empty($estado))) {
        
        $email_remetente = "contato@lauduz.org"; // deve ser uma conta de email do seu dominio 
        ...
        $email_conteudo = "FORMULÁRIO DE CONTATO\n"
            ...
            . "<br><b>crm:</b> " . $crm
            . "<br><b>Universidade:</b> " . $universidade
            . "<br><b>cpf:</b> " . $cpf
            . "<br><b>Data de Nascimento:</b> " . $datanascimento
            . "<br><b>especialidade:</b> " . $especialidade
            . "<br><b>cidade:</b> " . $cidade
            . "<br><b>estado:</b> " . $estado
            . "<br><br>"
            . "<hr>"
            . "<br>Mensagem cadastro de medico voluntario.";
